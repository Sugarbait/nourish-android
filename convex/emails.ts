...
const SITE_URL = "https://nourishapp.digitalac.app";
          ...
          <tr>
            <td style="padding:32px 36px 24px;">
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="width:36px;height:36px;background:rgba(16,185,129,0.15);border-radius:10px;text-align:center;vertical-align:middle;">
